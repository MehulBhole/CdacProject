...
export async function CompanyDetailsFetch()
{        
    try {
        const response = axios.get(`http://localhost:9090/getallcompanydetails`);
        return response; 
    }catch(error){
            console.log(error);
    }
...
export async function emailSendId(companyId)
{        
    try {
        const response = axios.get(`http://localhost:9090/companyemailsendstudent/${companyId}`);
        return response; 
    }catch(error){
            console.log(error);
    }
