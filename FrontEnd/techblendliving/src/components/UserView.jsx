            ...
            <Col xs={12} md={6} lg={3}>
              <Card className="card-img-top"
                ...
                <Card.Body>
                  ...
                  <Button style={{ backgroundColor: "#002D62" }} onClick={handleProperty} >Show Properties</Button>
                </Card.Body>
              </Card>
            </Col>
            </div>
            ...
            <Col xs={12} md={6} lg={3}>
              <Card className="card-img-top"
                ...
                <Card.Body>
                  ...
                  <Button style={{ backgroundColor: "#002D62" }} onClick={handleService}>Services</Button>
                </Card.Body>
              </Card>
            </Col>
            </div>
