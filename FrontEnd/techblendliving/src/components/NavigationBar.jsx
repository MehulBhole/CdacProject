...
import img from "../media2/logo.png";
...
export function NavigationBar() {
  ...
  return (
    <>
      <Navbar style={{ backgroundColor: "#002D62", position: "fixed", top: 0, width: "100%", zIndex: 1000 }} variant="dark">
        <Container>
          <LinkContainer to="/">
            <img
                  ...
                  <div class="dropdown nav-pad">
                    ...
                    <div class="dropdown-content">
                      <LinkContainer to="/login-user">
                        <Nav.Link>Login Student</Nav.Link>
                      </LinkContainer>

                      <LinkContainer to="/login-owner">
                        <Nav.Link>Login TPO</Nav.Link>
                      </LinkContainer>
              
                      <LinkContainer to="/login-host">
                        <Nav.Link>Login Admin</Nav.Link>
                      </LinkContainer>
                    </div>
                  </div>
                  <div class="nav-pad dropdown">
                    ...
                    <div class="dropdown-content">
                      ...
                      <LinkContainer to="/registrationowner">
                        <Nav.Link>TPO Registration</Nav.Link>
                      </LinkContainer>
