      ...
      <button className="feedback-btn" width="30px" onClick={() => {
        ...
        <div className="host">
          ...
          <div className="OwnerApproval">
            <center><h2>TPO Approval</h2></center>
                  ...
                  <tbody>
                    {owner.map(d =>
                      <tr>
                        ...
                        <td>
                          <Button className="btnapproval"style={{ marginLeft: 1 + 'em' }} variant="danger" onClick={() => {
                            handleDelete(d.id)
                          }}>Reject</Button>
                          <Button className="btnapproval" style={{ marginLeft: 1 + 'em' }} variant="success" onClick={() => {
                            handleApprove(d.id)
                          }}>Approve</Button>
                        </td>
                        <td>{d.Remarks}</td>
